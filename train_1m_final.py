...
# 2. Training Loop (1 Million steps)
...
# Using scan for efficient execution
state, _ = jax.lax.scan(train_step, state, jnp.arange(1000000))

end_time = time.time()
print(f"Training complete. 1 Million steps processed in {end_time - start_time:.2f}s.")

# Save final model
with open('uno_brain_1m_final.pkl', 'wb') as f:
    pickle.dump(state.params, f)
print("Model saved as uno_brain_1m_final.pkl")
